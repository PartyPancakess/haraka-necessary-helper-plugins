 ...
 */
export declare function expectReject(promise: Promise<any>, err: new (message: string) => Error): Promise<void>;
/**
 * Creates a new test etcd client.
 */
export declare function createTestClient(): Etcd3;
/**
 ...
 */
export declare function createTestKeys(client: Namespace): Promise<void>;
/**
