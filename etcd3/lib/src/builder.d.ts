...
export declare class ComparatorBuilder {
     ...
     * is truthy.
     */
    then(...clauses: Array<RPC.IRequestOp | IOperation>): this;
    /**
     * Adds one or more consequent clauses to be executed if the comparison
     * is falsey.
     */
    else(...clauses: Array<RPC.IRequestOp | IOperation>): this;
    /**
     ...
     */
    mapOperations(ops: Array<RPC.IRequestOp | IOperation>): Promise<RPC.IRequestOp>[];
}
